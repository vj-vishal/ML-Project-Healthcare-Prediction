...
model_young = joblib.load("Artifects\model_young.joblib")
model_rest = joblib.load("Artifects\model_rest.joblib")
scaler_young = joblib.load("Artifects\scaler_young.joblib")
scaler_rest = joblib.load("Artifects\scaler_rest.joblib")
